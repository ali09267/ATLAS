  ...
  return (
    <>
      <div className="store-header">
        ...
        <span className="store-title">🛍Alacena</span>
      ...
      >
        <div className="offcanvas-header">
          {user && <div className="store-user">Hi, {user.first_name}👋</div>}
          <br />
        ...
        <div className="offcanvas-body">
          <Link className="nav-link mb-3 mx-3" to="/">
            Home
          </Link>
          <Link className="nav-link mb-3 mx-3" to="/ai">
            AI Assistant
          </Link>

          <Link className="nav-link mb-3 mx-3" to="/tracker">
            Order Tracker
          </Link>
          ...
          <Link className="nav-link mb-3" to="/about">
            About Us
          </Link>
